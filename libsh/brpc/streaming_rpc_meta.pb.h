...
class StreamSettings final :
 ...
 public:
  ...
  private:
  int _internal_extra_stream_ids_size() const;
  public:
  void clear_extra_stream_ids();
  private:
  int64_t _internal_extra_stream_ids(int index) const;
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >&
      _internal_extra_stream_ids() const;
  void _internal_add_extra_stream_ids(int64_t value);
  ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >*
      _internal_mutable_extra_stream_ids();
  public:
  int64_t extra_stream_ids(int index) const;
  void set_extra_stream_ids(int index, int64_t value);
  void add_extra_stream_ids(int64_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >&
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t > extra_stream_ids_;
    int64_t stream_id_;
    bool need_feedback_;
    bool writable_;
  };
...
// repeated int64 extra_stream_ids = 4;
inline int StreamSettings::_internal_extra_stream_ids_size() const {
  return _impl_.extra_stream_ids_.size();
}
inline int StreamSettings::extra_stream_ids_size() const {
  return _internal_extra_stream_ids_size();
}
inline void StreamSettings::clear_extra_stream_ids() {
  _impl_.extra_stream_ids_.Clear();
}
inline int64_t StreamSettings::_internal_extra_stream_ids(int index) const {
  return _impl_.extra_stream_ids_.Get(index);
}
inline int64_t StreamSettings::extra_stream_ids(int index) const {
  // @@protoc_insertion_point(field_get:brpc.StreamSettings.extra_stream_ids)
  return _internal_extra_stream_ids(index);
}
inline void StreamSettings::set_extra_stream_ids(int index, int64_t value) {
  _impl_.extra_stream_ids_.Set(index, value);
  // @@protoc_insertion_point(field_set:brpc.StreamSettings.extra_stream_ids)
}
inline void StreamSettings::_internal_add_extra_stream_ids(int64_t value) {
  _impl_.extra_stream_ids_.Add(value);
}
inline void StreamSettings::add_extra_stream_ids(int64_t value) {
  _internal_add_extra_stream_ids(value);
  // @@protoc_insertion_point(field_add:brpc.StreamSettings.extra_stream_ids)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >&
StreamSettings::_internal_extra_stream_ids() const {
  return _impl_.extra_stream_ids_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >&
StreamSettings::extra_stream_ids() const {
  // @@protoc_insertion_point(field_list:brpc.StreamSettings.extra_stream_ids)
  return _internal_extra_stream_ids();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >*
StreamSettings::_internal_mutable_extra_stream_ids() {
  return &_impl_.extra_stream_ids_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< int64_t >*
StreamSettings::mutable_extra_stream_ids() {
  // @@protoc_insertion_point(field_mutable_list:brpc.StreamSettings.extra_stream_ids)
  return _internal_mutable_extra_stream_ids();
}
